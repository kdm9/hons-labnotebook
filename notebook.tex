...
\chapter*{Mon 2012-12-03}
  \section*{Initial Harvest of Keng's RIX lines}
    ...
    \subsection*{Results}
      ...
      \csvautolongtable{dec12/20121203-InitialHarvest.csv}
      \emph{Attachments:}
      \begin{itemize} \itemsep1pt \parskip0pt \parsep0pt
...
\chapter*{Mon 2012-12-10}
  \section*{Final Harvest of Keng's RIX lines}
    ...
    \csvautolongtable{dec12/20121210-FinalHarvest.csv}
    \emph{Attachments:}
    \begin{itemize} \itemsep1pt \parskip0pt \parsep0pt
...
\chapter*{Tue 2013-01-29}
  \section*{Seed Stock Levels}
    ...
    \csvautolongtable{jan/20130129-SeedStockLevels.csv}
...
\chapter*{Fri 2013-02-08}
  \section*{Planting of RIX lines}
    ...
    \subsection*{Method:}
      ...
      \csvautolongtable{./feb/20130208-KMPlantedLines.csv}
